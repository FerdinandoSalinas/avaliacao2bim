...
public class GUINivel extends JFrame {
    ...
    private JLabel labelTitulo = new JLabel("id do nivel: ");
    private JLabel lbIdNivel = new JLabel("id do nivel");
    private JTextField fdIdNivel = new JTextField(15);

    private JLabel lbNomeNivel = new JLabel("Nivel");
    private JTextField fdNomeNivel = new JTextField(45);
    ...
    DAONivel controle = new DAONivel();
    ...
    public GUINivel(){
        ...
        setTitle("Cadastro de Nivels");

        painelCentral.setLayout(new GridLayout(2, 2));
        painelCentral.add(lbNomeNivel);
        painelCentral.add(fdNomeNivel);

        fdNomeNivel.setEnabled(false);
...
cp.setBackground(Color.white);
        ...
        fdIdNivel.setFont(new Font("Courier New", Font.PLAIN, 20));
        lbIdNivel.setFont(new Font("Courier New", Font.BOLD, 17));
        lbNomeNivel.setFont(new Font("Courier New", Font.BOLD, 17));
        fdIdNivel.setFont(new Font("Courier New", Font.PLAIN, 17));
        fdNomeNivel.setFont(new Font("Courier New", Font.PLAIN, 17));
        ...
        btBuscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    nivel = new Nivel();
                    int idNivel = Integer.valueOf(fdIdNivel.getText());
                    nivel.setIdNivel(Integer.valueOf(fdIdNivel.getText()));
                    nivel = controle.obter(nivel.getIdNivel());
                    labelAviso.setBackground(Color.green);
                    if (nivel != null) {
                        fdIdNivel.setText(nivel.getIdNivel() + "");
                        fdNomeNivel.setText(nivel.getNomeNivel() + "");
        ...
        btInserir.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                acao = true;
                fdIdNivel.setEnabled(false);
                fdNomeNivel.setEnabled(true);
        ...
        btSalvar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(acao){ //btInserir
                    ...
                    nivel = new Nivel();
                        nivel.setIdNivel(Integer.valueOf(fdIdNivel.getText()));
                        nivel.setNomeNivel(fdNomeNivel.getText());
                        controle.inserir(nivel);
                        labelAviso.setText("Registro inserido com sucesso!");
                        fdIdNivel.setEnabled(true);
                        fdIdNivel.requestFocus();
                        fdNomeNivel.setEnabled(false);
                        btSalvar.setVisible(false);
                        btCancelar.setVisible(false);
        ...
        btRemover.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                btListar.setVisible(false);
                btAtualizar.setVisible(false);
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null, "Confirma a exclusão do registro <Chave = " + nivel.getIdNivel() + " >?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)) {
                    controle.remover(nivel);
        ...
        btListar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new NivelGUIListagem(controle.listInOrderNomeStrings("tanto faz"), cp);
            }
        }
        );
