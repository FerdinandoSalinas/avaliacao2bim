...
import Auxiliar.*;
// @author Radames
public class ProfessorGUIListagem extends JDialog {

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"id do professor","Nome"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public ProfessorGUIListagem(List<String> texto, Container cp2) {
        setTitle("Listagem de Professor");
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"id do professor","Nome"}, 0);
        int aux = 0;
