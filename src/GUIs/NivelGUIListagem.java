...
import Auxiliar.*;
// @author Radames
public class NivelGUIListagem extends JDialog {

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"id do nivel","Nivel"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public NivelGUIListagem(List<String> texto, Container cp2) {
        setTitle("Listagem de Nivel");
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"id do nivel","Nivel"}, 0);
        int aux = 0;
