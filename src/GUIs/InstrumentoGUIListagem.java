...
import Auxiliar.*;
// @author Radames
public class InstrumentoGUIListagem extends JDialog {

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"id","Nome","Valor da aula"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public InstrumentoGUIListagem(List<String> texto, Container cp2) {
        setTitle("Listagem de Instrumento");
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"id","Nome","Valor da aula"}, 0);
        int aux = 0;
